...
firebase addAction [ "<t color=""#93E352"">Shoot random with random color ", { [ [ getPos ( selectRandom [boat1,boat2,boat3] ), 'random', 'random' ], GRAD_fnc_callFireworks ] remoteExec ["call", 2 ]; }, _Args, 1, false, false, "" ];